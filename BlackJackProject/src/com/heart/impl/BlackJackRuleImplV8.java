...
public class BlackJackRuleImplV8 implements BlackjackRule {
...
//		}
	...
	public void gamerMoney() {
		...
		} else if (((pScore > dScore) || voD.getBust())) win();
			// 플레이어는 BUST가 아니면서 딜러보다 점수가 높거나, 딜러가 BUST면 승리
		else if (pScore < dScore) lose();
			// 플레이어, 딜러는 BUST가 아니면서 플레이어가 딜러보다 점수가 낮으면 패배
		else if (pScore == dScore) push();
			// 플레이어, 딜러는 BUST가 아니면서 플레이어와 딜러 점수가 같으면 무승부
